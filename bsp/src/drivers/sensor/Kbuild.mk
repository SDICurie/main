...
obj-$(CONFIG_BMI160) += bmi160_gpio.o bmi160_bus.o bmi160_support.o bmi160_drv.o bmi160_tcmd.o
...
obj-$(CONFIG_OHRM_DRIVER) += ohrm_bus.o ohrm_drv.o adxl362_support.o adxl362_bus.o
